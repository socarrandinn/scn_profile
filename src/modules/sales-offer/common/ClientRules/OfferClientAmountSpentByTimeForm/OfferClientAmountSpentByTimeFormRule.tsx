...
type OfferClientAmountSpentByTimeFormRuleProps = {
  section: boolean;
  control: any;
  name: string;
...
const OfferClientAmountSpentByTimeFormRule = ({ section, name }: OfferClientAmountSpentByTimeFormRuleProps) => {
...
export default memo(OfferClientAmountSpentByTimeFormRule);
