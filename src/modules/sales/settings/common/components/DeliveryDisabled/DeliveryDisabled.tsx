...
const DeliveryDisabled = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center mb-24 mt-5 relative'>
      ...
      >
        <Typography sx={{ fontSize: { xs: '24px', sm: '34px' }, fontWeight: 600 }}>
          {t('shippingDisabled.title')}
        </Typography>
        <Typography
          sx={{ textAlign: 'center', mb: 2, fontSize: { xs: '18px', sm: '22px' }, lineHeight: 1.2, color: '#2B3445' }}
        >
