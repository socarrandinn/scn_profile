...
import { HOME_DELIVERIES_GLOBAL_CENTER_KEY, HOME_DELIVERIES_GLOBAL_KEY } from 'modules/sales/settings/home-delivery/constants';
...
export const useFindOneShippingCenterSettings = (distributionCenterId: string) => {
  ...
  return useQuery<IDelivery>([HOME_DELIVERIES_GLOBAL_CENTER_KEY, distributionCenterId], fetch);
};
