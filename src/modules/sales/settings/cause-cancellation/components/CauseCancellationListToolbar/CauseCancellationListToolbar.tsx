...
const CauseCancellationListToolbar = () => {
  ...
  return (
    <>
      ...
      <GeneralActions>
        <PermissionCheck permissions={CAUSE_CANCELLATION_PERMISSIONS.CAUSE_CANCELLATION_WRITE}>
          <AddButton action={onOpen} />
        </PermissionCheck>
      </GeneralActions>
      <CauseCancellationCreateModal open={isOpen} onClose={onClose} />
    </>
  );
};

export default memo(CauseCancellationListToolbar);
