...
import { updateStockWarehouseSchema } from 'modules/inventory/settings/warehouse-area/schemas/add-product-warehouse-area.schema';
...
const useUpdateAvailableProductStockForm = (
  productId: string,
  onClose: () => void,
  ...
  const { control, handleSubmit, reset, watch, setValue } = useForm({
    resolver: yupResolver(updateStockWarehouseSchema),
    defaultValues,
  });
...
export default useUpdateAvailableProductStockForm;
