...
import { storeAreaSchema } from 'modules/inventory/settings/store-area/schemas/store-area.schema';
...
const useStoreAreaCreateForm = (onClose: () => void, defaultValues: IStoreArea = initValues) => {
  ...
  const { mutate, error, isLoading, isSuccess, data } = useMutation(
    (storeArea: IStoreArea) => StoreAreaService.saveOrUpdate(storeArea),
    {
