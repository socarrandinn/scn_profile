...
type DistributionCentersGeneralLocationsFormProps = {
  error: any;
  control: any;
  isLoading: boolean;
...
const DistributionCentersGeneralLocationsForm = ({
  ...
  return (
    <div>
      ...
      <Form onSubmit={onSubmit} control={control} isLoading={isLoading} id={'form-warehouse-locations'}>
...
export default memo(DistributionCentersGeneralLocationsForm);
