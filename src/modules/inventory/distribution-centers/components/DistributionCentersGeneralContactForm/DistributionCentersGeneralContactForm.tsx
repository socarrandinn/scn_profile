...
type DistributionCentersGeneralContactFormProps = {
  error: any;
  control: any;
  isLoading: boolean;
...
const DistributionCentersGeneralContactForm = ({ error, control, isLoading, onSubmit }: DistributionCentersGeneralContactFormProps) => {
  ...
  return (
    <div>
      ...
      <Form onSubmit={onSubmit} control={control} isLoading={isLoading} id={'form-distribution-centers-contact'}>
...
export default memo(DistributionCentersGeneralContactForm);
