import { ProductsRowActions } from 'modules/inventory/provider/products/components/ProductsRowActions';
...
import ProviderProdCell from 'modules/inventory/provider/products/components/ProviderProdCell/ProviderProdCell';
