import { ProductsList, ProvedorProducts } from 'modules/inventory/provider/products/pages';
...
import EditProviderProducts from 'modules/inventory/provider/products/pages/EditProviderProducts';
