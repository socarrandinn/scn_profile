...
import { ProviderProductsDetail } from 'modules/inventory/provider/products/context/ProvedorProductDetail';
import { PRODUCTS_PERMISSIONS } from 'modules/inventory/provider/products/constants';
import ProductStatusTable from 'modules/inventory/provider/products/components/DataPickerPoroduct/ProductsStatusTable';
import ImageProveProducts from 'modules/inventory/provider/products/components/UploadImgaEditProduct/ImageProveProducts';
