...
import { provedorProductTabs } from 'modules/inventory/provider/products/constants/tabs.products.details';
import ProProductsRoutes from 'modules/inventory/provider/products/routes/tabProductsRouter';
