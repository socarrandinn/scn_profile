...
import { LOGISTIC, LOGISTIC_ROLES_KEY } from 'modules/inventory/provider/logistics/constants';
...
const SelectSupplierRole = ({ name, multiple, label, helperText, ...props }: SelectSupplierRoleProps) => {
  return (
    <FormAsyncSelectAutocompleteField
      ...
      fetchFunc={() => RoleProvidersService.getProviderRoles(LOGISTIC)}
      queryKey={LOGISTIC_ROLES_KEY}
      autoHighlight
