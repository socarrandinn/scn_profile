...
import { useFindUsersInvitesBySpace } from 'modules/security/users-invite/hooks/useFindUsersInvites';
...
const LogisticUsersInviteListContainer = () => {
  ...
  const { isLoading, error, data } = useFindUsersInvitesBySpace(logisticId);
  return (
    <Box>
