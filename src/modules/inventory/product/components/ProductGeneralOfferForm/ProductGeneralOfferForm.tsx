...
type ProductGeneralOfferFormProps = {
  error: any;
  control: any;
  isLoading: boolean;
...
const ProductGeneralOfferForm = ({ error, control, isLoading, onSubmit }: ProductGeneralOfferFormProps) => {
  return (
    <Box paddingLeft={3}>
...
export default memo(ProductGeneralOfferForm);
