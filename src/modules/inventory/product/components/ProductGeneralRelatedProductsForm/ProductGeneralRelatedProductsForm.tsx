...
type ProductGeneralRelatedProductsFormProps = {
  error: any;
  control: any;
  isLoading: boolean;
...
const ProductGeneralRelatedProductsForm = ({
  error,
  control,
  isLoading,
  onSubmit,
}: ProductGeneralRelatedProductsFormProps) => {
  return (
    <Box paddingLeft={3}>
...
export default memo(ProductGeneralRelatedProductsForm);
