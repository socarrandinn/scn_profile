...
import { IProductProvider } from 'modules/inventory/common/interfaces';
import ProductProviderService from 'modules/inventory/common/services/productProviderService';
