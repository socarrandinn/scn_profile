...
const ProductTableRow = ({ remove, update, item, index, setError, warehouse }: ProductTableRowProps) => {
  const { t } = useTranslation('product');
  const { data, isLoading, error } = useFindOneCodeProducts(item?.item as string, warehouse);
