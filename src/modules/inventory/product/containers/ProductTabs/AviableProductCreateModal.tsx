...
import AddAviableProductFormSkeleton
  from 'modules/inventory/product/components/AddAviableForm/AddAviableProductFormSkeleton';
            ...
            <DialogContent>
                ...
                {!dataError && (
                    <ConditionContainer active={!loadingInitData} alternative={<AddAviableProductFormSkeleton/>}>
                        <AddAviableProductForm error={error} isLoading={isLoading} control={control}
                                               onSubmit={onSubmit}/>
                    </ConditionContainer>
                )}
            </DialogContent>
