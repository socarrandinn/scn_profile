...
type ProductDetailOfferUpdateContainerProps = {
...
const ProductDetailOfferUpdateContainer = ({
  dataError,
  initValue,
  loadingInitData,
  onClose,
}: ProductDetailOfferUpdateContainerProps) => {
...
export default memo(ProductDetailOfferUpdateContainer);
