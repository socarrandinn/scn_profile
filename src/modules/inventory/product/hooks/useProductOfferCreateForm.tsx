...
const initValues: Partial<IProduct> = {
  _id: '',
  offer: productInitValue.offer,
};

const useProductOfferCreateForm = (onClose: () => void, defaultValues: Partial<IProduct> = initValues) => {
...
// @ts-ignore
export default useProductOfferCreateForm;
