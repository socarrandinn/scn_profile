...
import { reasonForCompensationChangeSchema } from 'modules/inventory/product/settings/reason-for-compensation-change/schemas/reasonForCompensationChange.schema';
