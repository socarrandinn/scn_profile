...
import { ReasonForCompensationChangeRowActions } from 'modules/inventory/product/settings/reason-for-compensation-change/components/ReasonForCompensationChangeRowActions';
