...
import useReasonForCompensationChangeCreateForm from 'modules/inventory/product/settings/reason-for-compensation-change/hooks/useReasonForCompensationChangeCreateForm';
import { IReasonForCompensationChange } from 'modules/inventory/product/settings/reason-for-compensation-change/interfaces';
import {
  ReasonForCompensationChangeForm,
  ReasonForCompensationChangeFormSkeleton,
} from 'modules/inventory/product/settings/reason-for-compensation-change/components/ReasonForCompensationChangeForm';
