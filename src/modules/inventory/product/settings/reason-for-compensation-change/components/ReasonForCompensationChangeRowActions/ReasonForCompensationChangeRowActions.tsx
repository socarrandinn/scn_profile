...
import { useDeleteReasonForCompensationChange } from 'modules/inventory/product/settings/reason-for-compensation-change/hooks/useDeleteReasonForCompensationChange';
