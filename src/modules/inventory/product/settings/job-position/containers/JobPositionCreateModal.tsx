...
import useJobPositionCreateForm from 'modules/inventory/product/settings/job-position/hooks/useJobPositionCreateForm';
import { IJobPosition } from 'modules/inventory/product/settings/job-position/interfaces';
import {
  JobPositionForm,
  JobPositionFormSkeleton,
} from 'modules/inventory/product/settings/job-position/components/JobPositionForm';
