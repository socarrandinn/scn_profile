...
import { REASON_FOR_JOB_CHANGE_PERMISSIONS } from 'modules/inventory/product/settings/reason-for-job-change/constants';
import { REASON_FOR_COMPENSATION_CHANGE_PERMISSIONS } from 'modules/inventory/product/settings/reason-for-compensation-change/constants';
import { WORK_LOCATION_PERMISSIONS } from 'modules/inventory/product/settings/work-location/constants';
import { CATEGORY_PERMISSIONS } from 'modules/inventory/product/settings/category/constants';
