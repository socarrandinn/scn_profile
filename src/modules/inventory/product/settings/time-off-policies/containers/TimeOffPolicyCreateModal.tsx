...
import useTimeOffPolicyCreateForm from 'modules/inventory/product/settings/time-off-policies/hooks/useTimeOffPolicyCreateForm';
import { ITimeOffPolicies } from 'modules/inventory/product/settings/time-off-policies/interfaces';
import { FormAccumulateField } from 'modules/inventory/product/settings/time-off-policies/components/FormAccumulateField';
import { FormRulesField } from 'modules/inventory/product/settings/time-off-policies/components/FormRulesField';
import { SelectTimeOffType } from 'modules/inventory/product/settings/time-off-policies/components/SelectTimeOffType';
...
const TimeOffPolicyCreateModal = ({
  ...
  const { control, onSubmit, isLoading, error, reset, watch } = useTimeOffPolicyCreateForm(
    initValue,
    onClose,
  );
