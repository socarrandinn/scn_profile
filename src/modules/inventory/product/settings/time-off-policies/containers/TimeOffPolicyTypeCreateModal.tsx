...
import useTimeOffPolicyTypeCreateForm
  from 'modules/inventory/product/settings/time-off-policies/hooks/useTimeOffPolicyTypeCreateForm';
import SelectCommonInterval from 'modules/inventory/product/settings/time-off-policies/components/SelectCommonInterval';
