...
const useStoreProviderCreateForm = (onClose: () => void, defaultValues: Partial<IWarehouse> = initValues) => {
  ...
  const { mutate, error, isLoading, isSuccess, data } = useMutation(
    (basic: Partial<IWarehouse>) => WarehouseService.updateProvider(basic),
    {
