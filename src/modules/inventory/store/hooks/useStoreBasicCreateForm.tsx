...
import { storeBasicSchema } from 'modules/inventory/store/schemas/store.schema';
...
const useStoreBasicCreateForm = (onClose: () => void, defaultValues: Partial<IStore> = initValues) => {
