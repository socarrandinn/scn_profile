...
import { StoreGeneralProviderForm } from 'modules/inventory/store/components/StoreGeneralProviderForm';
import useStoreProviderCreateForm from 'modules/inventory/store/hooks/useStoreProviderCreateForm';
