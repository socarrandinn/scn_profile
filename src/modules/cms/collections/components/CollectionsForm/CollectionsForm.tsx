...
const CollectionsForm = ({ control, isLoading, setValue, onSubmit }: CollectionsFormProps) => {
  ...
  return (
    ...
    >
      <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 4, sm: 8, md: 12 }}>
        ...
        <Grid item xs={12}>
          <FormTextField fullWidth multiline required minRows={2} name='description' label={t('fields.description')} />
        </Grid>
