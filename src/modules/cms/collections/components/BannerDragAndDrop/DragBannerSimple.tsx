...
import CollectionAddElementBannerButton from '../../containers/CollectionAddElementBannerButton';
  ...
  if (data?.data.length === 0) {
    return (
      <Stack gap={2}>
        ...
        <CollectionAddElementBannerButton contentType={COLLECTION_CONTENT_TYPE.BANNER} buttonProps={{ fullWidth: true }} />
      </Stack>
    );
  }
