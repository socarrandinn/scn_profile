...
const RobotTxtListToolbar = () => {
  ...
  return (
        <>
            ...
            <GeneralActions>
                <PermissionCheck permissions={ROBOT_TXT_PERMISSIONS.ROBOT_TXT_WRITE}>
                    <AddButton action={onOpen}/>
                </PermissionCheck>
            </GeneralActions>
            <RobotTxtCreateModal open={isOpen} onClose={onClose}/>
        </>
  );
};

export default memo(RobotTxtListToolbar);
