...
const ClientRetypePassword = () => {
  const { client } = useClientDetails();
  const { t } = useTranslation(['common', 'account']);

  const { control, onSubmit, isLoading, typePassword } = useUserResetPasswordForm(client as IUser | undefined);
...
export default memo(ClientRetypePassword);
