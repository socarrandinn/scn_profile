...
import { clientBasicSchema } from 'modules/crm/clients/schemas/clients.schema';
...
const useClientBasicForm = (onClose: () => void, defaultValues: Partial<IClients> = initValues) => {
  ...
  const { mutate, error, isLoading, isSuccess, data } = useMutation(
    (clientsBasicInfo: Partial<IClients>) => ClientsService.saveOrUpdate(clientsBasicInfo),
    {
