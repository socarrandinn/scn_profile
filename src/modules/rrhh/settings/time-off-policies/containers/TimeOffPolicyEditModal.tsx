...
import { useFindOneTimeOffPolicy } from 'modules/rrhh/settings/time-off-policies/hooks/useFindOneTimeOffPolicy';
...
const TimeOffPolicyEditModal = () => {
  ...
  const { isLoading, data, error } = useFindOneTimeOffPolicy(entityId);
