...
} from 'modules/rrhh/settings/time-off-policies/constants/queries';
import { useParams } from 'react-router';
import { ITimeOffPolicyType } from 'modules/rrhh/settings/time-off-policies/interfaces';
import { timeOffPolicyTypeInitValues } from 'modules/rrhh/settings/time-off-policies/constants/time-off-policy-type-init-value.constants';
import { timeOffTypesSchema } from 'modules/rrhh/settings/time-off-policies/schemas';
