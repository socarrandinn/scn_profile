...
import useWorkLocationCreateForm from 'modules/rrhh/settings/work-location/hooks/useWorkLocationCreateForm';
import { IWorkLocation } from 'modules/rrhh/settings/work-location/interfaces';
import {
  WorkLocationForm,
  WorkLocationFormSkeleton,
} from 'modules/rrhh/settings/work-location/components/WorkLocationForm';
