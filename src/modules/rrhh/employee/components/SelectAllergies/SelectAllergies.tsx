...
import { EMPLOYEES_ALLERGIES_LIST_KEY } from 'modules/rrhh/employee/constants';
import EmployeeAllergiesService from 'modules/rrhh/employee/services/employee-allergies.service';
