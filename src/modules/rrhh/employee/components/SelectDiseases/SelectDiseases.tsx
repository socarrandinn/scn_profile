...
import { EMPLOYEES_DISEASES_LIST_KEY } from 'modules/rrhh/employee/constants';
import EmployeeDiseasesService from 'modules/rrhh/employee/services/employee-diseases.service';
