...
import { EMPLOYEES_DISEASES_LIST_KEY } from 'modules/rrhh/employee/management/constants';
import EmployeeDiseasesService from 'modules/rrhh/employee/management/services/employee-diseases.service';
