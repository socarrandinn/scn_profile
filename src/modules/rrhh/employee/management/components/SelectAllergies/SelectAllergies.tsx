...
import { EMPLOYEES_ALLERGIES_LIST_KEY } from 'modules/rrhh/employee/management/constants';
import EmployeeAllergiesService from 'modules/rrhh/employee/management/services/employee-allergies.service';
