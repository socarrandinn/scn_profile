...
} from 'modules/rrhh/employee/management/components/SelectReasonForJobInformationChanged';
                        ...
                        <Form onSubmit={onSubmit} control={control} isLoading={isLoading} size={'small'}
                            ...
                            <Box pt={2}>
                                <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                                    ...
                                    <Grid item xs={12}>
                                        <FormCheckBoxField name={'isEnd'}
                                                           label={t('fields.jobInformation.endActivated')}/>
                                        {isEnd && <FormDatePickerField
                                            fullWidth
                                            name='endActivated'
                                        />
                                        }
                                    ...
                                    <Grid item xs={12}>
                                        <SelectEngagement required name='engagement'
                                                          label={t('fields.hiring.engagement')}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <SelectJobPosition required name='position'
                                                           label={t('fields.jobInformation.position')}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <SelectEmployee name='reported' label={t('fields.jobInformation.reported')}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <SelectWorkLocation required name='location'
                                                            label={t('fields.jobInformation.location')}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <SelectReasonForJobInformationChanged
                                            required
