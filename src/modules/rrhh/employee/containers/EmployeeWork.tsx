...
import EmployeeJobInformationListContainer from 'modules/rrhh/employee/containers/EmployeeJobInformationListContainer';
import { FormPaper } from 'modules/common/components/FormPaper';
import { useTranslation } from 'react-i18next';
import EmployeeCompensationListContainer from 'modules/rrhh/employee/containers/EmployeeCompensationListContainer';
import EmployeeCategoryListContainer from './EmployeeCategoryListContainer';
import { PermissionCheck } from '@dfl/react-security';
import { Button } from '@mui/material';
import CategoryCreateModal from 'modules/rrhh/employee/containers/CategoryCreateModal';
import JobInformationCreateModal from 'modules/rrhh/employee/containers/JobInformationCreateModal';
import CompensationCreateModal from 'modules/rrhh/employee/containers/CompensationCreateModal';
