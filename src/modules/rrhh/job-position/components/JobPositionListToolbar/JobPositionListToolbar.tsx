...
import JobPositionCreateModal from 'modules/rrhh/job-position/containers/JobPositionCreateModal';
import { useDeleteManyJobPositions } from 'modules/rrhh/job-position/hooks/useDeleteManyJobPositions';
