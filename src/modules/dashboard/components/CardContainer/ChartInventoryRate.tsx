...
import useBarCardExampleRate from 'modules/dashboard/hooks/useBarCardExampleRate';

const ChartInventoryRate = () => {
  const { series, options } = useBarCardExampleRate();
...
export default memo(ChartInventoryRate);
