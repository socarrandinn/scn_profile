...
import logisticRoutes from 'modules/provider/logistics/routes/tabLogisticsRouter';
import { logisticsTabs } from 'modules/provider/manufacture/constants/tabs.logistic.details';
