...
import { ICompensation, IEmployee, JobInformation } from 'modules/store/employee/common/interfaces';
import { ContactsPreview } from 'modules/store/employee/employee-detail/common/components/ContactsPreview';
import { CategorySection } from 'modules/store/employee/employee-detail/common/components/CategorySection';
...
import ContactSocial from 'modules/store/employee/employee-detail/common/components/ContactsPreview/ContactSocial';
import { useTranslation } from 'react-i18next';
import { EngagementValue } from 'modules/store/employee/common/components/EngagementValue';
import { HirePreview } from 'modules/store/employee/employee-detail/common/components/HirePreview';
...
import { CompensationCard } from 'modules/store/employee/employee-detail/common/components/CompensationCard';
