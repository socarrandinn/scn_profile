...
import AvatarEmployee from 'modules/store/employee/employee-detail/common/components/AvatarEmployee/AvatarEmployee';
import { IEmployeeUpdate } from 'modules/store/employee/common/interfaces';
...
import { employeeTabs } from 'modules/store/employee/employee-detail/common/constants';
