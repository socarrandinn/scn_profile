...
import { IEmployeeContactInfo, ISocialMediaInfo } from 'modules/store/employee/common/interfaces';
import ContactsPhones from 'modules/store/employee/employee-detail/common/components/ContactsPreview/ContactsPhones';
import ContactsEmail from 'modules/store/employee/employee-detail/common/components/ContactsPreview/ContactsEmail';
