...
import { EmployeeJobInformationService } from 'modules/store/employee/management/services';
import { EMPLOYEE_JOB_INFORMATION_LIST_KEY, EMPLOYEE_ONE_KEY } from 'modules/store/employee/management/constants/queries';
