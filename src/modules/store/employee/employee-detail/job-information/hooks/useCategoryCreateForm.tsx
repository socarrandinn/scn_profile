...
import { categorySchema } from 'modules/store/employee/management/schemas/category.schema';
import { EmployeeCategoryService } from 'modules/store/employee/management/services';
import { useEffect } from 'react';
import { IEmployeeCategory } from 'modules/store/employee/common/interfaces';
import { EMPLOYEE_CATEGORY_LIST_KEY, EMPLOYEE_ONE_KEY } from 'modules/store/employee/management/constants/queries';
