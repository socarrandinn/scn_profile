...
import EmployeeJobInformationListContainer from 'modules/store/employee/employee-detail/job-information/containers/EmployeeJobInformationListContainer';
import { FormPaper } from 'modules/common/components/FormPaper';
import { useTranslation } from 'react-i18next';
import EmployeeCompensationListContainer from 'modules/store/employee/employee-detail/job-information/containers/EmployeeCompensationListContainer';
import EmployeeCategoryListContainer from './EmployeeCategoryListContainer';
import { PermissionCheck } from '@dfl/react-security';
import { Button } from '@mui/material';
import CategoryCreateModal from 'modules/store/employee/employee-detail/job-information/containers/CategoryCreateModal';
import JobInformationCreateModal from 'modules/store/employee/employee-detail/job-information/containers/JobInformationCreateModal';
import CompensationCreateModal from 'modules/store/employee/employee-detail/job-information/containers/CompensationCreateModal';
