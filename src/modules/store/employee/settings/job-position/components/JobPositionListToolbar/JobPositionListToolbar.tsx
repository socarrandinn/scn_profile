...
import JobPositionCreateModal from 'modules/store/employee/settings/job-position/containers/JobPositionCreateModal';
...
// import { useDeleteManyJobPositions } from 'modules/store/employee/settings/job-position/hooks/useDeleteManyJobPositions';
