...
import useJobPositionCreateForm from 'modules/store/employee/settings/job-position/hooks/useJobPositionCreateForm';
import { IJobPosition } from 'modules/store/employee/settings/job-position/interfaces';
import {
  JobPositionForm,
  JobPositionFormSkeleton,
} from 'modules/store/employee/settings/job-position/components/JobPositionForm';
