...
import { useDeleteReasonForCompensationChange } from 'modules/store/employee/settings/reason-for-compensation-change/hooks/useDeleteReasonForCompensationChange';
