...
import useWorkLocationCreateForm from 'modules/store/employee/settings/work-location/hooks/useWorkLocationCreateForm';
import { IWorkLocation } from 'modules/store/employee/settings/work-location/interfaces';
import {
  WorkLocationForm,
  WorkLocationFormSkeleton,
} from 'modules/store/employee/settings/work-location/components/WorkLocationForm';
