...
import useEmployeePersonalUpdateForm from 'modules/store/employee/employee-detail/general/hooks/useEmployeePersonalUpdateForm';
import SocialMediaInfoForm from 'modules/store/employee/management/containers/EmploySections/SocialMediaInfoForm';

const EmployeeSocialMediaInfo = () => {
...
export default memo(EmployeeSocialMediaInfo);
