...
import { IEmployee, IEmployeeCreate } from 'modules/store/employee/common/interfaces';
...
import { CreateEmployeeSchema } from 'modules/store/employee/management/schemas';
