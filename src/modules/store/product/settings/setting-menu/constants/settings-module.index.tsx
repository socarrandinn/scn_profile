...
import { REASON_FOR_JOB_CHANGE_PERMISSIONS } from 'modules/store/product/settings/reason-for-job-change/constants';
import { REASON_FOR_COMPENSATION_CHANGE_PERMISSIONS } from 'modules/store/product/settings/reason-for-compensation-change/constants';
import { WORK_LOCATION_PERMISSIONS } from 'modules/store/product/settings/work-location/constants';
import { CATEGORY_PERMISSIONS } from 'modules/store/product/settings/category/constants';
import { TIME_OFF_POLICES_PERMISSIONS } from 'modules/store/product/settings/time-off-policies/constants/time-off-polices.permissions';

export const rrhhSettingsMenu: IMenuItemPage[] = [
  {
    title: 'category:categoryList',
    description: 'category:description',
    path: '/store/product/settings/categories',
  ...
  },
  {
    ...
    path: '/store/product/settings/job-positions',
  ...
  },
  {
    ...
    path: '/store/product/settings/reason-for-job-change',
  ...
  },
  {
    ...
    path: '/store/product/settings/reason-for-compensation-change',
  ...
  },
  {
    ...
    path: '/store/product/settings/work-locations',
  ...
  },
  {
    ...
    path: '/store/product/settings/time-off-policies',
