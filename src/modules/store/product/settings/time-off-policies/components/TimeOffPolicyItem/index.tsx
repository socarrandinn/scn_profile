...
import { useDeleteTimeOffPolicy } from 'modules/store/product/settings/time-off-policies/hooks/useDeleteTimeOffPolicy';
...
const TimeOffPolicyItem = ({ item, rowId }: TimeOffPolicyItemProps) => {
  ...
  const goTo = () => {
    navigate(`/store/product/settings/time-off-policies?edit=${rowId}&editType=${EditTypeEnum.TIME_OFF_POLICY}`);
  };
