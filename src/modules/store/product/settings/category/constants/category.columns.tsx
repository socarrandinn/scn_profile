import { CategoryRowActions } from 'modules/store/product/settings/category/components/CategoryRowActions';
...
import CategoryCell from 'modules/store/product/settings/category/components/CategoryCell';
