...
import useJobPositionCreateForm from 'modules/store/product/settings/job-position/hooks/useJobPositionCreateForm';
import { IJobPosition } from 'modules/store/product/settings/job-position/interfaces';
import {
  JobPositionForm,
  JobPositionFormSkeleton,
} from 'modules/store/product/settings/job-position/components/JobPositionForm';
