...
import useWorkLocationCreateForm from 'modules/store/product/settings/work-location/hooks/useWorkLocationCreateForm';
import { IWorkLocation } from 'modules/store/product/settings/work-location/interfaces';
import {
  WorkLocationForm,
  WorkLocationFormSkeleton,
} from 'modules/store/product/settings/work-location/components/WorkLocationForm';
