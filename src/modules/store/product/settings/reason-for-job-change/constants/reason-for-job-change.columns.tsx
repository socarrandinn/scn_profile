...
import { IReasonForJobChange } from 'modules/store/product/settings/reason-for-job-change/interfaces';
...
import { ReasonForJobChangeRowActions } from 'modules/store/product/settings/reason-for-job-change/components/ReasonForJobChangeRowActions';
