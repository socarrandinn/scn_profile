import { LogisticsRowActions } from 'modules/store/provider/logistics/components/LogisticsRowActions';
...
import { LOGISTICS_PERMISSIONS } from 'modules/store/provider/logistics/constants/logistics.permissions';
import { IAddressWithLocation } from 'modules/common/interfaces';
import ProviderLogCell from 'modules/store/provider/logistics/components/ProviderLogCell/ProviderLogCell';
import { AddressValue } from 'modules/common/components/Address';
import LogisticStatusTableDataPicker from 'modules/store/provider/logistics/components/DataPickerLogistic/LogisticStatusTable';
import ComissionCell from 'modules/store/provider/logistics/components/ComissionCell/ComissionCell';
