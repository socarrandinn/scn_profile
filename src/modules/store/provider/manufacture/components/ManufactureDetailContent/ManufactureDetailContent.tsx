...
import { manufactureTabs } from 'modules/store/provider/manufacture/constants/tabs.details';
import { useBreadcrumbName } from '@dfl/mui-admin-layout';
import tabActionRoutes from 'modules/store/provider/manufacture/routes/tabActionRoutes';
