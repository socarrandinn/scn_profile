...
const ProductDiscountSummary = () => {
  ...
  return (
    <Stack gap={2} flexDirection={{ xs: 'column', md: 'row' }} flexWrap='wrap'>
      <CounterBox
        title={t('detail.report.summary.orders')}
        value={150}
        flexGrow={1}
        currency={false}
        // @ts-ignore
      ...
      />
      <CounterBox
        title={t('detail.report.summary.customers')}
        value={30}
        flexGrow={1}
        currency={false}
        // @ts-ignore
      ...
      />
      <CounterBox
        title={t('detail.report.summary.discountAmount')}
        value={150}
        flexGrow={1}
        currency={false}
        // @ts-ignore
      ...
      <CounterBox
        title={t('detail.report.summary.IncomeAmount')}
        value={800}
        flexGrow={1}
        currency={false}
        // @ts-ignore
