...
import { FormTextField, Span, LoadingButton, HandlerError, Paragraph, ConditionContainer } from '@dfl/mui-react-common';
      ...
      >
        ...
        <form onSubmit={onSubmit}>
          <Grid container columnSpacing={2} rowSpacing={4}>
            <Grid item xs={12}>
              <FormTextField name='identifier' label={t('common:email')} control={control} disabled={isLoading} />
            </Grid>
          </Grid>
          <Box mt={4}>
